...
export class BrandsComponent implements AfterViewInit{
  ...
  dataSource: MatTableDataSource<Brand> = new MatTableDataSource();  // Initialize with an empty MatTableDataSource

  @ViewChild(MatPaginator) paginator!: MatPaginator;
  @ViewChild(MatSort) sort!: MatSort;

  constructor(private brandService: BrandService) {  // Use constructor injection
